        ...
        <div class="row">
            <div class="col-lg-2 mb-3 mb-lg-0 order-lg-2">
                @if(Auth::user() && \App\Enums\UserRole::manager(Auth::user()->role))
                    <a class="btn btn-success btn-block" href="{{ $product->id }}/edit">Edit</a>
                        ...
                        <div class="col-lg-2">
                            @if(Auth::user() && \App\Enums\UserRole::manager(Auth::user()->role))
                                <a class="btn btn-success btn-block"
                                   href="{{ $product->id }}/parts/{{ $part->id }}/edit">Edit</a>
                                <form method="post" action="{{ $product->id }}/parts/{{ $part->id }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-success btn-block mt-1">Delete</button>
                                </form>
                    ...
                    <div class="list-group-item my-1">
                        <div class="row">
                            <div class="col">
                                ...
                                <hr class="my-2">
                                <form method="POST" action="{{ $product->id }}/parts">
                                    @csrf
