            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/users/profile/{{ $user->id }}/edit">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" autocomplete="surname" autofocus
                                    value="{{ $user->surname }}" >
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/users/profile/{{ $user->id }}/passwd">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password-old" type="password" class="form-control @error('password-old') is-invalid @enderror" name="password-old" autocomplete="new-password">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/users/profile/{{ $user->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password-old" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password">
